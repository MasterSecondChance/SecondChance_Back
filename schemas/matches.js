...
const matchSchema = joi.object({
  ...
  urlPhotoArticleFirst: matchUserSecondSchema,
  nameSecond: matchUserSecondSchema.required(),
  phoneSecond: matchUserSecondSchema.required(),
  urlPhotoArticleSecond: matchUserSecondSchema,
  firstArticleName: matchUserFirstSchema,
  secondArticleName: matchUserFirstSchema,
  urlChat: matchUrlChatSchema,
